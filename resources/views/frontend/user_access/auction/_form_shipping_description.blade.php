<div class="row">
    <div class="col-lg-6">
        <div class="form-group">
            <label for="{{ fake_field('name') }}" class="control-label text-muted required">{{ __('Nom :') }}</label>
    ...
    <div class="col-lg-6">
        <div class="form-group">
            <label for="{{ fake_field('phone_number') }}"
                   class="control-label text-muted required">{{ __('Numero du contact :') }}</label>
    ...
    <div class="col-lg-12">
        <div class="form-group">
            <label for="{{ fake_field('address') }}"
                   class="control-label text-muted required">{{ __('Adresse :') }}</label>
    ...
    <div class="col-lg-12">
        <div class="form-group">
            <label for="{{ fake_field('country') }}"
                   class="control-label text-muted required">{{ __('Pays :') }}</label>

            {{ Form::select(fake_field('country_id'), $countries, old('country_id'), ['class'=> 'custom-select country', 'v-on:change'=> "onChange(".'$event'.")", 'id' => fake_field('country_id'),'data-cval-name' => 'The parent category field', 'data-cval-rules' => 'required','placeholder' => __('Selectionner le pays')]) }}
            <span class="invalid-feedback cval-error"
    ...
    <div class="col-lg-4">
        <div class="form-group">
            <label for="{{ fake_field('post_code') }}"
                   class="control-label text-muted required">{{ __('Code postal :') }}</label>
    ...
    <div class="col-lg-4">
        <div class="form-group">
            <label for="{{ fake_field('city') }}" class="control-label text-muted required">{{ __('Cité :') }}</label>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <select class="custom-select" name="state_id" :disabled="disableStateDom">
                    <option>{{__('Selectionner Etat')}}</option>
